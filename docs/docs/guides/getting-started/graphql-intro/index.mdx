...
The schema above tells you _everything_ that you can do with the API. You can fetch a list of customers, and you can update a customer's email address - but not their name.
